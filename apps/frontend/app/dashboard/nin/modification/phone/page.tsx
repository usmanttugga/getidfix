      ...
      <div className="max-w-lg">
        <div className="bg-white rounded-xl border border-slate-300 p-8 text-center">
          ...
          <div className="flex gap-3 justify-center">
            <button onClick={() => { setSuccess(null); setForm({ nin: '', surname: '', firstName: '', middleName: '', newPhoneNumber: '' }); }}
  ...
  return (
    <div className="max-w-lg">
      <div className="bg-white rounded-xl border border-slate-300 p-6">
        ...
        <p className="text-sm text-slate-500 mb-5">Fill in your details to submit a phone number modification request.</p>
