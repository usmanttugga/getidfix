      ...
      <div className="max-w-lg">
        <div className="bg-white rounded-xl border border-slate-300 p-6">
          ...
          <div className="flex items-center gap-4 mb-5 p-4 bg-slate-50 rounded-xl">
            ...
            <div>
              <p className="font-semibold text-slate-900">{String(r.fullName || '')}</p>
              <p className="text-sm text-slate-500">NIN: {nin}</p>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-3 mb-5">
            <div className="bg-slate-50 rounded-lg p-3">
              <p className="text-xs text-slate-500 mb-1">Date of Birth</p>
              <p className="font-medium text-slate-800 text-sm">{String(r.dob || '—')}</p>
            </div>
            <div className="bg-slate-50 rounded-lg p-3">
              <p className="text-xs text-slate-500 mb-1">Gender</p>
              <p className="font-medium text-slate-800 text-sm">{String(r.gender || '—')}</p>
            </div>
          </div>
          ...
          <button onClick={() => { setResult(null); setNin(''); setSlipType(null); }} className="mt-4 w-full py-2 border border-slate-300 text-slate-700 rounded-lg text-sm hover:bg-slate-50">
            Verify Another
          </button>
        </div>
      </div>
